<template lang="html">
	<keep-alive>
		<div style="background: #fff;" ref="wrapper" class="main-body newsList" infinite-scroll-disabled="loading"
		 infinite-scroll-distance="10" @scroll="handleScroll">
					...
					<div class="page-search">
						<router-link to="/search">
							<div class="mint-searchbar">
								<div class="mint-searchbar-inner"><i class="mintui mintui-search"></i> <input type="search" placeholder="请输入要搜索的内容"
